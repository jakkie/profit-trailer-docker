...
Compatible with Profit Trailer bot version : v2.1.0 - v2.1.10
...
- To build with a specific Profit Trailer version from version v2.1.10 and later. Just change the Profit Trailer version to the version you want. To see which versions are available go to `https://github.com/taniman/profit-trailer/releases`

```bash
docker build -t profit-trailer --build-arg PT_VERSION=2.1.10 .
```
